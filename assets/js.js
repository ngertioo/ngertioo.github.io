...
window.addEventListener('load', function() { 
    var inputElement = document.getElementById("dailyInput");
    var dots = '';

    // Set interval untuk memperbarui nilai input setiap 500 milidetik
    ...
    // Simulasikan proses loading data (contoh: 5000 milidetik atau 5 detik)
    setTimeout(function() {
    ...
    xhr.onreadystatechange = function() {
        if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            var resultDiv = htmlDoc.getElementById('yesterday').innerHTML;

            document.getElementById("dailyInput").value = resultDiv;
            // document.getElementById("loading").style.display = "none";
    ...
    // Tambahkan logika atau panggilan fungsi lain di sini setelah loading selesai
    // Misalnya, memanggil fungsi untuk menghilangkan loader atau menampilkan data
    // hideLoader();
    }, 5000);
